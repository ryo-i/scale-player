                ...
                <section>
                    ...
                    <section>
                        ...
                        <dl>
                            ...
                            <dd>
                                <p>構成音：1, 3, 5, 8, 10, 13<br />
                                1, 2, 3, 5, 6度の五音音階。Cキーではすべて白鍵。メジャー・ペンタトニック・スケール、宮調式と同じスケール。</p>
                                <figure>
                            ...
                            <dd>
                                <p>構成音：1, 3, 6, 8, 11, 13<br />
                                1, 2, 4, 5, b7度の五音音階。7度（Cキーではシ）がフラット。律旋法の6度（Cキーではラ）を半音上げたスケールでもある。</p>
                                <figure>
                    ...
                    <section>
                        ...
                        <dl>
                            ...
                            <dd>
                                <p>構成音：1, 3, 5, 8, 10, 13<br />
                                1, 2, 3, 5, 6度の五音音階。Cキーではすべて白鍵。メジャー・ペンタトニック・スケール、宮調式、呂旋法と同じスケール。「ヨナ抜き」とは4、7度を抜くこと。</p>
                                <figure>
