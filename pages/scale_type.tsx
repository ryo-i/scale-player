            ...
            <section>
                ...
                <section>
                    <section>
                        ...
                        <p>アラブのマカームといわれる音楽の音階。1/4音下げる微分音（四分音）があり「q（正式には逆さまのフラット）」で表すが、十二音鍵盤では再現が難しいため、半音下げのフラットの置き換えた。</p>
                        <dl>
                            <dt>マカーム・ラースト</dt>
                            <dd>
                                <p>構成音：1, 3, 4, 6, 8, 10, 11, 13<br />
                            ...
                            <dd>
                                <p>構成音：1, 2, 5, 6, 8, 9, 11, 13<br />
                                1, b2, 3, 4, 5, b6, b7度の七音音階。2、6、7度（Cキーではレ、ラ、シ）がフラット。ハーモニック・マイナー・パーフェクト5th・ビロウ・スケールと同一のスケール。</p>
                                <figure>
                            ...
                            <dd>
                                <p>構成音：1, 2, 4, 6, 8, 9, 11, 13<br />
                                1, b2, b3, 4, 5, b6, b7度の七音音階。2、3、6、7度（Cキーではレ、ミ、ラ、シ）がフラット。フリジアン・スケールと同一のスケール。</p>
                                <figure>
                    ...
                    <section>
                        ...
                        <dl>
                            ...
                            <dd>
                                <p>構成音：1, 3, 5, 6, 8, 10, 12, 13<br />
                                1, 2, 3, 4, 5, 6, 7度の七音音階。メジャー・スケールと同一のスケールでCキーではすべて白鍵になる。</p>
                                <figure>
                            ...
                            <dd>
                                <p>構成音：1, 3, 5, 6, 8, 10, 11, 13<br />
                                1, 2, 3, 4, 5, 6, b7度の七音音階。7度（Cキーではシ）がフラット。ミクソリディアン・スケールと同一のスケール。</p>
                                <figure>
                            ...
                            <dd>
                                <p>構成音：1, 3, 4, 6, 8, 10, 11, 13<br />
                                1, 2, b3, 4, 5, 6, b7度の七音音階。3、7度（Cキーではミ、シ）がフラット。ドリアン・スケールと同一のスケール。</p>
                                <figure>
                            ...
                            <dd>
                                <p>構成音：1, 3, 4, 6, 8, 9, 11, 13<br />
                                1, 2, b3, 4, 5, b6, b7度の七音音階。3、6、7度（Cキーではミ、ラ、シ）がフラット。ナチュラル・マイナー・スケールと同一のスケール。</p>
                                <figure>
                            ...
                            <dd>
                                <p>構成音：1, 2, 5, 6, 8, 9, 12, 13<br />
                                1, b2, 3, 4, 5, b6, 7度の七音音階。2、6度（Cキーではレ、ラ）がフラット。ジプシー・スケールと同一のスケール。</p>
                                <figure>
                            ...
                            <dd>
                                <p>構成音：1, 3, 5, 7, 8, 10, 12, 13<br />
                                1, 2, 3, #4, 5, 6, 7度の七音音階。4度（Cキーではファ）がシャープ。リディアン・スケールと同一のスケール。</p>
                                <figure>
